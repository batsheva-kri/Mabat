...
def SupplierReportsScreen(page, current_user, navigator):
    ...
    def load_report(e=None):
        ...
        for i, r in enumerate(rows_data):
            actions_row = ft.Row(
                controls=[
                    ft.IconButton(icon=ft.Icons.EDIT, icon_color="#52b69a", icon_size=24, tooltip="ערוך"),
                    ft.IconButton(icon=ft.Icons.DELETE, icon_color="#f28c7d", icon_size=24, tooltip="מחק")
                ],
                spacing=8
            )
